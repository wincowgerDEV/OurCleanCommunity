...
Trips <- fread("G:/My Drive/GrayLab/Projects/Plastics/ActiveProjects/TrackingTrashReceipts/Data/Raw Data/Trips_by_Distance.csv")
...
register_google(key = "AIzaSyBsCOp0W7UyBjbEjDXvdRV2RIN4Wk7p1lU") #to run mutate_geocode function
set_key(key = "AIzaSyBsCOp0W7UyBjbEjDXvdRV2RIN4Wk7p1lU") #To run google_find_place function
...
#Get weather data https://www.ncdc.noaa.gov/cdo-web/webservices/v2#data stationid=WBAN:03171 ----

#NOAA
token = "vmBtTdHGiKALLgfgSUwUxYnwHCWrPEIf"
  url = "https://www.ncdc.noaa.gov/cdo-web/api/v2/data?datasetid=WBAN&stationid=WBAN:03171&startdate=2017-01-01&enddate=2017-12-31"

Meteostat
url ="https://api.meteostat.net/v2/stations/search?query=KRAL"
key =  "1MbOFuwnsx4k04Hf7FIPtOvz7qa0EqzS"
url = "https://api.meteostat.net/v2/stations/hourly?station=KRAL0&start=2020-02-01&end=2020-02-04"

a <- GET(url, add_headers("x-api-key" = key))

prettify(rawToChar(a$content))
